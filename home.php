        ...
        <div style="max-width: 100%;text-align: justify;" class="mx-auto p-3 font-2 optimize-fonts">
            <div class="col-12 row p-2 d-flex justify-content-center">
                ...
                <?php
                    if (have_posts()) {
                        while (have_posts()) {
                            ...
                            ?>
                            <div class="col-12 col-12 col-md-6 col-lg-3" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                ...
                <?php
                        ...
                        ?>
                        <h1 class="py-3 text-center fw-bold"><?php _e('Sorry', 'pw') ?></h1>
                        <h6 class="text-center"><?php _e('There are no posts at the moment', 'pw') ?></h6>
                        <?php
                    }
                ?>
